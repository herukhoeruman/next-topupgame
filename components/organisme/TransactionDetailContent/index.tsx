          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="OrderID" value="#GG001" />
                <Row label="Item" value="259 Diamond" />
                <Row label="Price" value={400000} />
                <Row label="Tax 10%" value={400000} />
                <Row label="Total" value={400000} className="color-palette-4" />
              </div>
              <div className="payment pt-10 pb-10">
                <h2 className="fw-bold text-xl color-palette-1 mb-20">
                  Payment Informations
                </h2>
                <Row label="Your Account Name" value="masayoshizero" />
